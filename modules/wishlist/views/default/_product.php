<div class="product_block">
	...
	<div class="name">
		<?php echo Html::link(CHtml::encode($data->name), array('/shop/product/view', 'seo_alias'=>$data->seo_alias)) ?>
	</div>
	<div class="price">
		<?php
	...
	<div class="actions">
		...
		{
			echo CHtml::link(Yii::t('ShopModule.core', 'Удалить'), array('/wishlist/remove','id'=>$data->id),array(
				'class'=>'remove',
			));
		}
		echo CHtml::endForm()
