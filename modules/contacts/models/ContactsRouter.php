...
class ContactsRouter extends ActiveRecord {
            ...
            'elements' => array(
                'general' => array(
                    ...
                    'elements' => array(
                        ...
                        'opacity' => array('type' => 'SelectInput', 'data' => self::getOpacityList(),),
                    ),
                ),
                'start_point' => array(
                    'type' => 'form',
                    ...
                    'elements' => array(
                        ...
                        'start_balloon_content_body' => array('type' => 'textarea', 'class' => 'editor'),
                        'start_icon_content' => array('type' => 'text'),
                    ),
                ),
                'end_point' => array(
    ...
    public function getJsonRoute() {
        ...
        $array = array(
            ...
            'coords' => array(
                array((float) $ecoord[0], (float) $ecoord[1]),
                array((float) $scoord[0], (float) $scoord[1])
            )
        );
