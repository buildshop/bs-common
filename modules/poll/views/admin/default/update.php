<div class="fluid">
    ...
    'title' => $this->pageName,
    'htmlOptions' => array('class' => 'fluid grid6')
));  ?>
...
<div class=" grid6">
    ...
    <div class="widget">
        ...
        <table class="tDefault tMedia">
            ...
            <div class="grid12 textC"><?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('core', 'CREATE', 0) : Yii::t('core', 'SAVE'), array('class' => 'buttonS bGreen')); ?></div>
            <div class="clear"></div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function removeInput(id, filter_id){
        ...
        $.ajax({
            type: 'POST',
            url:'/admin/poll/default/update?id=<?php echo $model->id ?>',
