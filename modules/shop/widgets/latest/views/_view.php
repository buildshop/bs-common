<div class="product-box">
    ...
    <div class="browseBlock">
            ...
            <?php
            if ($data->mainImage)
                echo CHtml::link(CHtml::image($data->mainImage->getUrl(Yii::app()->settings->get('shop','img_preview_size_list'), 'resize'), $data->mainImage->title), '/product/'.$data->seo_alias, array('class' => 'thumbnail'));
            else
                echo CHtml::link(CHtml::image('http://placehold.it/'.Yii::app()->settings->get('shop','img_preview_size_list')), '#', array('class' => 'thumbnail'));
            ?>
    ...
    <div class="fleft">
        ...
        <div class="buts">
            ...
            <span class="item-do">
                ...
                echo CHtml::hiddenField('pcs', $data->pcs);
