...
<div id="shop-sort-sorter">
    ...
    echo Html::dropDownList('sort', Yii::app()->request->getParam('sort'), array(
       // Yii::app()->request->removeUrlParam('/shop/category/view', 'sort') => Yii::t('core', 'EMPTY_DROPDOWNLIST', 1),
        ...
        'date_create.desc' => Yii::t('ShopModule.default', 'SORT_BY', 2),
            ), array('onchange' => 'applyCategorySorter(this)','empty'=>Yii::t('core', 'EMPTY_DROPDOWNLIST', 1)));
    ?>
</div>
