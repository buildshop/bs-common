<?php if ($this->beginCache('_sorting', array('duration' => Yii::app()->settings->get('core','cache_time')))) { ?>
    ...
    <div class="row">
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
            ...
            <?php
            echo Html::dropDownList('per_page', Yii::app()->request->url, $limits, array('onchange' => 'applyCategorySorter(this)'));
            ?>
