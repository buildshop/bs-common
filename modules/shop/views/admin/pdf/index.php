...
<table border="1" width="100%">
    ...
    <th width="10%">Ящиков</th>
    <th width="30%">Цена закупки</th>
    <th width="30%">Цена за ящик</th>
    </tr>
    <?php $total=0; $totalPCS=0; ?>
    <?php foreach($dataProvider->getData() as $row){ ?>
    <?php $total +=$row->prd->price_purchase * $row->prd->pcs; ?>
    <?php $totalPCS +=$row->quantity; ?>
    <tr>
        ...
        <td align="center"><span class="pr"><?= $row->prd->price_purchase * $row->prd->pcs;?></span> <?php echo Yii::app()->currency->active->symbol?></td>
    </tr>
    <?php } ?>
</table><br/><br/>
...
<div style="text-align:right">Ящиков: <span id="total_price"><?php echo $totalPCS?></span></div>