...
class ListView extends CListView {
    ...
    public function init() {
        ...
        if ($this->baseScriptUrl === null)
            $this->baseScriptUrl = Yii::app()->assetManager->publish(Yii::getPathOfAlias('ext.adminList.assets'), false, -1, YII_DEBUG);


        if (Yii::app()->controller instanceof Controller) {
            $htmlClass = 'pager-' . Yii::app()->controller->module->id;
        } else {
            $htmlClass = '';
        }
        $this->pager = CMap::mergeArray(array(
            'cssFile' => ((Yii::app()->controller instanceof Controller) ? Yii::app()->theme->baseUrl . '/assets/css' : $this->baseScriptUrl) . '/pager.css',
    ...
    public function renderEmptyText() {
        ...
        Yii::app()->tpl->alert('info', $emptyText);
    }
