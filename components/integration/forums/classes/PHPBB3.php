...
class PHPBB3 extends GlobalClass {
    ...
    public function log_out() {
        ...
        $this->FDB->createCommand("DELETE FROM {$this->tbl_prefix}sessions_keys WHERE key_id = '" . md5($phpbb_key) . "'")->execute();
        $this->FDB->createCommand("DELETE FROM {$this->tbl_prefix}sessions WHERE session_id = '" . $phpbb_sid . "'")->execute();
